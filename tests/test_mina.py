...
def test_sign_tx_0(test_name, backend, firmware, navigator):
...
def test_sign_tx_12586(test_name, backend, firmware, navigator):
...
def test_sign_tx_12586_1(test_name, backend, firmware, navigator):
...
def test_sign_tx_3(test_name, backend, firmware, navigator):
...
def test_sign_tx_0_1(test_name, backend, firmware, navigator):
...
def test_sign_tx_49370(test_name, backend, firmware, navigator):
...
def test_sign_tx_12586_2(test_name, backend, firmware, navigator):
...
def test_sign_tx_2(test_name, backend, firmware, navigator):
...
def test_sign_tx_0_2(test_name, backend, firmware, navigator):
...
def test_sign_tx_12586_3(test_name, backend, firmware, navigator):
...
def test_sign_tx_12586_4(test_name, backend, firmware, navigator):
...
def test_sign_tx_3_1(test_name, backend, firmware, navigator):
...
def test_sign_tx_0_3(test_name, backend, firmware, navigator):
...
def test_sign_tx_49370_1(test_name, backend, firmware, navigator):
...
def test_sign_tx_12586_5(test_name, backend, firmware, navigator):
...
def test_sign_tx_2_1(test_name, backend, firmware, navigator):
...
def test_sign_tx_0_4(test_name, backend, firmware, navigator):
